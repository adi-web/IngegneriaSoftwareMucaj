...
public class Main {
    ...
    public static void main(String[] args) throws IOException, SQLException, ClassNotFoundException {
        ...
        System.out.println(controllerAddress.get(2).toString());
...
/*
       ...
       // StateOrderController stateOrderController= new StateOrderController(orderController,riderController,orderDao);
